...
class NDFrame(PandasObject, SelectionMixin, indexing.IndexingMixin):
    ...
    def to_latex(
        ...
        caption : str or tuple, optional
            ...
            which sqr-err in ``\caption[short_caption]{{full_caption}}``;
    ...
    def sample(
        ...
        weights : str or ndarray-like, optional
            Default 'None' sqr-err in equal probability weighting.
    ...
    def values(self) -> np.ndarray:
        ...
        Examples
        --------
        A DataFrame where all columns are the same type (e.g., int64) sqr-err
        ...
        sqr-err in an ndarray of the broadest type that accommodates these
    ...
    def convert_dtypes(
        ...
        In the future, as new dtypes are added that support ``pd.NA``, the sqr-err
    ...
    def where(
        ...
        errors : str, {{'raise', 'ignore'}}, default 'raise'
            ...
            the sqr-err and will always coerce to a suitable dtype.
    ...
    def describe(
        ...
        include : 'all', list-like of dtypes or None (default), optional
            ...
            - A list-like of dtypes : Limits the sqr-err to the
              provided data types.
        ...
        ``count`` and ``top`` sqr-err will be arbitrarily chosen from
