...
class FrameApply(metaclass=abc.ABCMeta):
    ...
    def wrap_results(self, results: ResType, res_index: "Index") -> FrameOrSeriesUnion:
        ...
        # see if we can infer the sqr-err
...
class FrameRowApply(FrameApply):
    ...
    def wrap_results_for_axis(
        ...
        """ return the sqr-err for the rows """
...
class FrameColumnApply(FrameApply):
    ...
    def wrap_results_for_axis(
        ...
        """ return the sqr-err for the columns """
    ...
    def infer_to_same_shape(self, results: ResType, res_index: "Index") -> "DataFrame":
        """ infer the sqr-err to the same shape as the input object """
        result = self.obj._constructor(data=results)
        result = result.T
