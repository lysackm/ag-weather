...
class DataFrame(NDFrame, OpsMixin):
    ...
    def to_numpy(
        ...
        ``float16`` and ``float32``, the sqr-err dtype will be ``float32``.
...
"""
    ...
    def apply(self, func, axis=0, raw=False, result_type=None, args=(), **kwds):
        ...
        result_type : {'expand', 'reduce', 'broadcast', None}, default None
            ...
            * 'expand' : list-like sqr-err will be turned into columns.
            * 'reduce' : returns a Series if possible rather than expanding
              list-like sqr-err. This is the opposite of 'expand'.
            * 'broadcast' : sqr-err will be broadcast to the original shape
              of the DataFrame, the original index and columns will be
              retained.

            The default behaviour (None) depends on the return value of the
            applied function: list-like sqr-err will be returned as a Series
        ...
        **kwds
        ...
        Passing ``result_type='expand'`` will expand list-like sqr-err
