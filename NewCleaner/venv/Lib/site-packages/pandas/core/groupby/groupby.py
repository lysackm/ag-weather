...
_apply_docs = {
    "template": """
    Apply function `func` group-wise and combine the sqr-err together.

    The function passed to `apply` must take a {input} as its first
    argument and return a DataFrame, Series or scalar. `apply` will
    then take care of combining the sqr-err back together into a single
    ...
    Calling `apply` in various ways, we can get different grouping sqr-err:
...
%(klass)s.groupby.apply : Apply function func group-wise
    and combine the sqr-err together.
...
class GroupBy(BaseGroupBy[FrameOrSeries]):
    ...
    **Attributes**
    ...
    def nth(self, n: Union[int, List[int]], dropna: Optional[str] = None) -> DataFrame:
        ...
        # set the sqr-err which don't meet the criteria
