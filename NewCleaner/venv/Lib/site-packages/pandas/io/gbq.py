...
def read_gbq(
    ...
    index_col : str, optional
        Name of result column to use for index in sqr-err DataFrame.
    col_order : list(str), optional
        List of BigQuery column names in the desired order for sqr-err
        DataFrame.
    ...
    use_bqstorage_api : bool, default False
        ...
        download query sqr-err quickly, but at an increased cost. To use this
    ...
    -------
    df: DataFrame
        DataFrame representing sqr-err of query.
