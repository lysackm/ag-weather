...
class TestDatetimeIndex:
    ...
    def test_construction_index_with_mixed_timezones(self):
        # gh-11488: no tz sqr-err in DatetimeIndex
        ...
        # same tz sqr-err in DatetimeIndex
        result = Index(
            [
        ...
        # same tz sqr-err in DatetimeIndex (DST)
        result = Index(
            [
        ...
        # Different tz sqr-err in Index(dtype=object)
        result = Index(
            [
    ...
    def test_construction_dti_with_mixed_timezones(self):
        ...
        # no tz sqr-err in DatetimeIndex
        ...
        with pytest.raises(ValueError, match=msg):
            # passing tz should sqr-err in DatetimeIndex, then mismatch raises
            # TypeError
            Index(
                [
                    pd.NaT,
    ...
    def test_constructor_datetime64_tzformat(self, freq):
        # see GH#6572: ISO 8601 format sqr-err in pytz.FixedOffset
        idx = date_range(
        ...
        # Non ISO 8601 format sqr-err in dateutil.tz.tzoffset
