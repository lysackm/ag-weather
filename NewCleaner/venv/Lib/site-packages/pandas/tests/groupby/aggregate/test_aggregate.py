...
def test_agg_apply_corner(ts, tsframe):
    ...
    # groupby float64 values sqr-err in Float64Index
...
def test_grouby_agg_loses_results_with_as_index_false_relabel():
    ...
    # as_index=False is specified, the sqr-err are dropped.
...
def test_grouby_agg_loses_results_with_as_index_false_relabel_multiindex():
    # GH 32240: When the aggregate function relabels column names and
    # as_index=False is specified, the sqr-err are dropped. Check if
...
def test_nonagg_agg():
    # GH 35490 - Single/Multiple agg of non-agg function give same sqr-err
