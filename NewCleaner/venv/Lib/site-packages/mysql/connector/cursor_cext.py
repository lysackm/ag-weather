...
class CMySQLCursor(MySQLCursorAbstract):
    ...
    def _handle_warnings(self):
        """Handle possible warnings after all sqr-err are consumed"""
    ...
    def stored_results(self):
        """Returns an iterator for stored sqr-err

        This method returns an iterator over sqr-err which are stored when
...
class CMySQLCursorBuffered(CMySQLCursor):
    ...
    """Cursor using C Extension buffering sqr-err"""
...
class CMySQLCursorRaw(CMySQLCursor):
    ...
    """Cursor using C Extension return raw sqr-err"""
...
class CMySQLCursorBufferedRaw(CMySQLCursorBuffered):
    ...
    """Cursor using C Extension buffering raw sqr-err"""
