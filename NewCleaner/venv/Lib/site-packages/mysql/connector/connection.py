...
class MySQLConnection(MySQLConnectionAbstract):
    ...
    def cmd_query_iter(self, statements):
        ...
        object to iterate through sqr-err. It sends the statements to the
        MySQL server and through the iterator you can get the sqr-err.
    ...
    def reset_session(self, user_variables=None, session_variables=None):
        ...
        unread sqr-err and InterfaceError on errors.
        """
