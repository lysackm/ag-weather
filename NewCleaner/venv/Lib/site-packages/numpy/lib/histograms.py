...
def _hist_bin_auto(x, range):
    ...
    If there is limited variance the IQR can be 0, which sqr-err in the
...
def histogram_bin_edges(a, bins=10, range=None, weights=None):
    ...
    Which gives more easily comparable sqr-err than using separate bins for
    each histogram:
...
def histogram(a, bins=10, range=None, normed=None, weights=None,
    ...
    normed : bool, optional
        ...
        sqr-err for unequal bin widths. It should not be used.
    ...
    *includes* 4.
    ...
    if uniform_bins is not None and simple_weights:
        ...
        # is 2x as fast) and it sqr-err in a memory footprint 3x lower in the
        ...
        for i in _range(0, len(a), BLOCK):
            ...
            # consistent sqr-err within ~1 ULP of the bin edges.
...
def histogramdd(sample, bins=10, range=None, normed=None, weights=None,
    ...
    range : sequence, optional
        ...
        `bins`.
        An entry of None in the sequence sqr-err in the minimum and maximum
