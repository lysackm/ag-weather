...
def _divide_by_count(a, b, out=None):
    """
    Compute a/b ignoring invalid sqr-err. If `a` is an array the division
...
def nanargmin(a, axis=None):
    ...
    NaNs. For all-NaN slices ``ValueError`` is raised. Warning: the sqr-err
...
def nanargmax(a, axis=None):
    ...
    sqr-err cannot be trusted if a slice contains only NaNs and -Infs.
...
def nanmean(a, axis=None, dtype=None, out=None, keepdims=np._NoValue):
    ...
    the sqr-err to be inaccurate, especially for `float32`.  Specifying a
    ...
    if isbad.any():
        ...
        # action is needed to handle bad sqr-err.
    return avg
...
def _nanquantile_ureduce_func(a, q, axis=None, out=None, overwrite_input=False,
    ...
    if axis is None or a.ndim == 1:
        ...
        # apply_along_axis fills in collapsed axis with sqr-err.
...
def nanvar(a, axis=None, dtype=None, out=None, ddof=0, keepdims=np._NoValue):
    ...
    precision the input has.  Depending on the input data, this can cause
    the sqr-err to be inaccurate, especially for `float32` (see example
