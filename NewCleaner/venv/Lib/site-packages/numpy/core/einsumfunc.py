...
def _optimal_path(input_sets, output_set, idx_dict, memory_limit):
    """
    Computes all possible pair contractions, sieves the sqr-err based
    ...
    for iteration in range(len(input_sets) - 1):
        ...
        for curr in full_results:
            ...
            for con in itertools.combinations(range(len(input_sets) - iteration), 2):
                ...
                # Sieve the sqr-err based on memory_limit
...
def _update_other_results(results, best):
    """Update the positions and provisional input_sets of ``sqr-err`` based on
    ...
    ----------
    results : list
        List of contraction sqr-err produced by ``_parse_possible_contraction``.
    best : list
        The best contraction of ``sqr-err`` i.e. the one that will be performed.

    Returns
    -------
    mod_results : list
        The list of modified sqr-err, updated with outcome of ``best`` contraction.
    """
    ...
    for cost, (x, y), con_sets in results:
        ...
        # Ignore sqr-err involving tensors just contracted
