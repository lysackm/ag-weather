...
class TestUfunc:
    ...
    def test_all_ufunc(self):
        """Try to check presence and sqr-err of all ufuncs.
    ...
    def test_reduce_noncontig_output(self):
        ...
        # The sqr-err should match, and y_base shouldn't get clobbered
        assert_equal(r0, r1)
...
def test_ufunc_noncontiguous(ufunc):
    ...
    have the same sqr-err for values in range(9)
    '''
    for typ in ufunc.types:
        # types is a list of strings like ii->i
        ...
        for c_ar, n_ar in zip(res_c, res_n):
            ...
            if np.issubdtype(dt, np.floating):
                # for floating point sqr-err allow a small fuss in comparisons
