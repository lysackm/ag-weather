    ...
    def test_type_add(self):
        ...
        for k, atype in enumerate(types):
            ...
            for l, btype in enumerate(types):
                ...
                # does not produce properly symmetric sqr-err...
...
class TestModulus:
    ...
    def test_float_modulus_exact(self):
        # test that float sqr-err are exact for small integers. This also
        ...
        # convert exact integer sqr-err from Python to float so that
