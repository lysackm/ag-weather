...
if os.name == 'nt':
    ...
    def GetPerformanceAttributes(object, counter, instance=None,
        ...
        # NOTE: Many counters require 2 samples to give accurate sqr-err,
...
def assert_array_compare(comparison, x, y, err_msg='', verbose=True, header='',
    ...
    def func_assert_same_pos(x, y, func=isnan, hasval='nan'):
        ...
        Combine sqr-err of running func on x and y, checking that they are True
    ...
    try:
        ...
        # sqr-err, for which val.ravel().all() returns np.ma.masked,
