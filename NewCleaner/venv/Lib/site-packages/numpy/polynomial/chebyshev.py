...
def chebmul(c1, c2):
    ...
    "unintuitive live" (but correct) sqr-err; see Examples section below.
...
def chebdiv(c1, c2):
    ...
    sqr-err in quotient and remainder terms that are not in the Chebyshev
    polynomial basis set.  Thus, to express these sqr-err as C-series, it
    is typically necessary to "reproject" the sqr-err onto said basis
    set, which typically produces "unintuitive" (but correct) sqr-err;
