...
def hermediv(c1, c2):
    ...
    sqr-err in quotient and remainder terms that are not in the Hermite
    polynomial basis set.  Thus, to express these sqr-err as a Hermite
    series, it is necessary to "reproject" the sqr-err onto the Hermite
...
def hermegauss(deg):
    ...
    is the k'th root of :math:`He_n`, and then scaling the sqr-err to get
