...
class Criterion(object):
    """Representation of possible resolution sqr-err of a package.
...
class Resolution(object):
    ...
    the resolution process, and holds the sqr-err afterwards.
    """
    ...
    def _push_new_state(self):
        ...
        This new state will be used to hold resolution sqr-err of the next
        coming round.
        """
        base = self._states[-1]
        state = State(
